...
@Component({
    selector: 'app-thong-ke-don-hang-theo-khu-vuc',
    templateUrl: './thong-ke-don-hang-theo-khu-vuc.component.html',
    styleUrls: ['./thong-ke-don-hang-theo-khu-vuc.component.scss']
})
export class ThongKeDonHangTheoKhuVucComponent extends SecondPageIndexBase implements OnInit {
    ...
    async getData() {
        ...
        await this._StatisticsService.Report_chart_Order_Provinces(
