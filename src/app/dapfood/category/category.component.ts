...
export class CategoryComponent extends SecondPageIndexBase implements OnInit {
    searchModel: any = {
        key: ''
    };
    dataTree: any = [];
    ...
    ShowHideHtmlDescription() {
        this.hideHtmlDescription = !this.hideHtmlDescription;
    }
