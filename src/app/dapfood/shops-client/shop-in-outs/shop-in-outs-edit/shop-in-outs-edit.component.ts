...
@Component({
    selector: 'app-shop-in-outs-edit',
    templateUrl: './shop-in-outs-edit.component.html',
    styleUrls: ['./shop-in-outs-edit.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class ShopInOutsEditComponent extends SecondPageEditBase
    implements OnInit {
    key: string;
    isNew = false;
    isLoading = false;
