...
export class Utilities {
    ...
    public static readonly noNetworkMessageCaption = "Bạn đang ngoại tuyến";
    public static readonly noNetworkMessageDetail = "Không thể kết nối đến máy chủ!";
    public static readonly accessDeniedMessageCaption = "Không có quyền truy cập";
    public static readonly accessDeniedMessageDetail = "";

    public static getErrorDescription(error): string {
      if (Utilities.checkNoNetwork(error)) {
        return Utilities.noNetworkMessageDetail;
      }
      else if (error.status == 403) {
        return this.accessDeniedMessageCaption;
      }
      else {
